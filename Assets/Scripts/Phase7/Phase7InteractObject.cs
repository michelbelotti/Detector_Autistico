...
public class Phase7InteractObject : MonoBehaviour
{
    ...
    private Phase7Manager scriptPhase;
    ...
    void Start()
    {
        ...
        scriptPhase = GameObject.Find("Phase_7_Manager").GetComponent<Phase7Manager>();
    }
